...
public class PurchaseRecordInterface extends Contract {
    ...
    @Deprecated
    protected PurchaseRecordInterface(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice,
            BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected PurchaseRecordInterface(String contractAddress, Web3j web3j, Credentials credentials,
            ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected PurchaseRecordInterface(String contractAddress, Web3j web3j, TransactionManager transactionManager,
    ...
    public RemoteFunctionCall<TransactionReceipt> addPurchase(String _address) {
        final Function function = new Function(FUNC_ADDPURCHASE,
    ...
    public RemoteFunctionCall<TransactionReceipt> cancelPurchase(String _address) {
        final Function function = new Function(FUNC_CANCELPURCHASE,
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(160, _address)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteFunctionCall<TransactionReceipt> confirmDeposit(String _address) {
        final Function function = new Function(FUNC_CONFIRMDEPOSIT,
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(160, _address)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteFunctionCall<TransactionReceipt> confirmPurchase(String _address) {
        final Function function = new Function(FUNC_CONFIRMPURCHASE,
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(160, _address)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteFunctionCall<TransactionReceipt> sendItem(String _address) {
        final Function function = new Function(FUNC_SENDITEM,
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(160, _address)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    @Deprecated
    public static PurchaseRecordInterface load(String contractAddress, Web3j web3j, Credentials credentials,
            BigInteger gasPrice, BigInteger gasLimit) {
        return new PurchaseRecordInterface(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static PurchaseRecordInterface load(String contractAddress, Web3j web3j,
    ...
    public static RemoteCall<PurchaseRecordInterface> deploy(Web3j web3j, Credentials credentials,
            ContractGasProvider contractGasProvider) {
        return deployRemoteCall(PurchaseRecordInterface.class, web3j, credentials, contractGasProvider, BINARY, "");
    }

    @Deprecated
    public static RemoteCall<PurchaseRecordInterface> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice,
            BigInteger gasLimit) {
        return deployRemoteCall(PurchaseRecordInterface.class, web3j, credentials, gasPrice, gasLimit, BINARY, "");
    }

    public static RemoteCall<PurchaseRecordInterface> deploy(Web3j web3j, TransactionManager transactionManager,
            ContractGasProvider contractGasProvider) {
