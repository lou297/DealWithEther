                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="description" v-model="item.description" placeholder=""></textarea>
                                            </div>
                                            <div class="form-group">
...
export default {
    ...
    methods: {
        ...
        save() {
            ...
            if (this.item.name.length <= 0 || this.item.category.length <= 0 || this.item.price === null || this.item.price <= 0 || this.item.imgName === null || this.item.imgName.length <= 0) {
