<template>
    <div>
        ...
        <!-- <div style="padding: 36px;">
            <div>
                <a href="#" style="font-weight:bold;float:left;">중코마켓</a>
            </div>
            <div>
                <a href="#" style="font-weight:bold;">상점</a>
                <a href="#" style="margin-left:60px; font-weight:bold;">판매하기</a>
                <a href="#" style="margin-left:60px; font-weight:bold;">마이페이지</a>
                <a href="#" style="margin-left:60px; font-weight:bold;">로그아웃</a>
            </div>
        </div>
        -->

        <section class="hero-banner" style="margin-bottom:0px; height:600px;"> 
            <div class="container">
                <div class="row no-gutters align-items-center pt-60px">
                <div class="col-5 d-none d-sm-block">
                    <div class="hero-banner__img">
                    <img class="img-fluid" style="height:528px;width:500px;" src="../../public/images/hero-banner.png" alt="">
                    </div>
                </div>
